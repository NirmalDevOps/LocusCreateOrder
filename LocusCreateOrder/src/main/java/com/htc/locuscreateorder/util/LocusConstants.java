package com.htc.locuscreateorder.util;

/**
 * Represents a Constant Class for Locus Create Order
 * 
...
public class LocusConstants {
	...
	public static final String AUTHORIZATION_KEY = "167eb8d0-aab4-44e0-99c4-0469945d2bae";
	public static final String SUCCESS = "Success";
	public static final String FAILURE = "Failure";
	public static final String ERROR_MESSAGE = "Error : ";
	public static final String ORDER_CREATION_SUCCESS = "Order Created Successfully!!!";
	public static final String ORDER_CREATION_FAILED = "Order Creation Failed";
	public static final String JSON_PROCESSING_ERROR = "Error in processing Locus Request Body";
	...
	public static final int RETRY_COUNT_CHECK = 4;
